								...
								<div className="page-banner-entry text-center">
									...
									<nav aria-label="breadcrumb" className="breadcrumb-row">
										<ul className="breadcrumb">
											...
											<li className="breadcrumb-item active" aria-current="page">Detalhes do Blog</li>
										</ul>
									</nav>
								</div>
							</div>
									...
									<div className="blog-card blog-single">
										...
										<div className="info-bx">
											<ul className="post-meta">
												<li className="author"><Link to="/blog-details"><img src={testPic1} alt=""/> Edineia Saraiva</Link></li>
												<li className="date"><i className="far fa-calendar-alt"></i>  21 de Junho de 2024</li>
											</ul>
											<div className="ttr-post-title">
												<h2 className="post-title">A Importância do acompanhamento psicológico nos casos de Autismo</h2>
											</div>
